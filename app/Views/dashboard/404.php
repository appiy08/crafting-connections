...
<body class="app app-404-page">   	
	    ...
	    <div class="row">
		    <div class="col-12 col-md-11 col-lg-7 col-xl-6 mx-auto">
			    <div class="app-branding text-center mb-5">
		            <a class="app-logo" href="<?=base_url('/')?>"><img class="logo-icon me-2" src="<?=base_url("assets/images/app-logo.svg")?>" alt="logo"><span class="logo-text">PORTAL</span></a>
			    ...
			    <div class="app-card p-5 text-center shadow-sm">
				    ...
				    <a class="btn app-btn-primary" href="<?=base_url('/')?>">Go to home page</a>
			    </div>
		    </div><!--//col-->
	    </div><!--//row-->
    </div><!--//container-->
    ...
    <script src="<?=base_url("assets/js/charts-custom.js")?>"></script>
