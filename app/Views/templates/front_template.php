...
<body>
                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <?php else : ?>
                                <div class="app-utility-item app-user-dropdown dropdown">
                                    <a class="dropdown-toggle" id="user-front-dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false"><img src="<?php if ($user_data['avatar']) {
        ...
        <div class="container-fluid bg-body-tertiary">
            <div class="row">
                <div class="col-12 py-4">
                    <p class="m-0">&copy; <?= date('Y') ?> Crafting Connections. Design & Developed By Appiy08 &#10084;.</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <!-- Prism Theme -->
    <script src="<?= base_url('assets/vendor/prism/prism.js') ?>" data-manual referrerpolicy="origin"></script>
