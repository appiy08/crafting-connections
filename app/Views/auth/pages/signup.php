...
<section>
				...
				<div class="app-auth-body mx-auto">
					...
					<div class="auth-form-container text-start mx-auto">
						...
						<div class="username mb-3">
							...
							<input id="signup-name" name="username" type="text" value="<?=set_value('username')?>" class="form-control signup-name" placeholder="Full name" />
	...
	echo $validation->getError('username');
						...
						<div class="email mb-3">
							...
							<input id="signup-email" name="email" type="email" value="<?=set_value('email')?>" class="form-control signup-email" placeholder="Email" />
							<p class="text-danger fs-7">
								<?php if (isset($validation)) {
	echo $validation->getError('email');
						...
						<div class="password mb-3">
							...
							<input id="signup-password" name="password" type="password" value="<?=set_value('password')?>" class="form-control signup-password" placeholder="Create a password" />
							<p class="text-danger fs-7">
								<?php if (isset($validation)) {
